 ...
 */
final class Version20241012100114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservations CHANGE nombre_places nombre_places INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservations CHANGE nombre_places nombre_places INT DEFAULT NULL');
    }
}
