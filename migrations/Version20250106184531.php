...
final class Version20250106184531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP FOREIGN KEY IF EXISTS FK_8F91ABF0A76ED395');
        $this->addSql('DROP INDEX IF EXISTS IDX_8F91ABF0A76ED395 ON avis');
        $this->addSql('ALTER TABLE avis DROP COLUMN IF EXISTS user_id');
        $this->addSql('ALTER TABLE incidents DROP FOREIGN KEY IF EXISTS FK_E65135D0F971F91F');
        $this->addSql('DROP INDEX IF EXISTS IDX_E65135D0F971F91F ON incidents');
        $this->addSql('ALTER TABLE incidents DROP COLUMN IF EXISTS employes_id');
        $this->addSql('DROP INDEX IF EXISTS IDX_4DA239A76ED395 ON reservations');
        $this->addSql('ALTER TABLE reservations DROP COLUMN IF EXISTS user_id');
    }
