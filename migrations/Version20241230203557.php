 ...
 */
final class Version20241230203557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE films DROP qualite, DROP image_name, DROP image_size');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE cinemas_films (cinemas_id INT NOT NULL, films_id INT NOT NULL, INDEX IDX_A5215F8FC5C76018 (cinemas_id), INDEX IDX_A5215F8F939610EE (films_id), PRIMARY KEY(cinemas_id, films_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE films ADD qualite VARCHAR(255) NOT NULL, ADD image_name VARCHAR(255) DEFAULT NULL, ADD image_size INT DEFAULT NULL');
    }
}
